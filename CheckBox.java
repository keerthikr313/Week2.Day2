...
public class CheckBox {
	public static void main(String[] args) {
		...
		boolean selected1 = driver.findElement(By.xpath("//label[text()='Select the languages that you know?']/following::input")).isSelected();
		System.out.println("The checkbox is selected" + selected1);
